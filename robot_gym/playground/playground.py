...
from robot_gym.controllers.simple import simple_controller
...
class Playground:
    ...
    def setup_ctrl_class_params(self):
        ...
        simple_ctrl = self._sim.pybullet_client.addUserDebugParameter("Simple controller", 0, -1, 0)
        return mcp_ctrl, pose_ctrl, bezier_ctrl, simple_ctrl
    ...
    def parse_ctrl_class_params(self, ui):
        ...
        simple_flag = self._sim.pybullet_client.readUserDebugParameter(ui[3])
        if mpc_flag % 2 != 0:
            self._current_ctrl = mpc_controller.MPCController
            ...
            return True, self._current_ctrl
        elif simple_flag % 2 != 0:
            self._current_ctrl = simple_controller.SimpleController
            return True, self._current_ctrl
